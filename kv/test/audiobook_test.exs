defmodule AudiobookTest do
    ...
    def get_completed_percentual_string(completed, remaining) do
    ...
    test "having read/heard the audiobook for some time inputing string" do
        assert get_completed_percentual_string("00:00", "9:00") == 0
        assert get_completed_percentual_string("1:00", "9:00") == 10
        assert get_completed_percentual_string("09:00", "00:00") == 100
    end
end
